{{ config(
  ...
  cluster_by = ['date'],
  tags = ['snowflake', 'mirror', 'console', 'mirror_terra_new_acct']
) }}

-- original by cryptoicicle https://app.flipsidecrypto.com/velocity/queries/136044cb-8900-4453-8188-b8e4238a8094
WITH jdata as (
