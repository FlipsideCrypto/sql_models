...
SELECT 
  ...
  total_value_pooled,
  SUM(total_value_bonded) OVER (ORDER BY total_value_bonded_tbl.day ASC) AS total_value_bonded,
  total_value_pooled + SUM(total_value_bonded) OVER (ORDER BY total_value_bonded_tbl.day ASC) AS total_value_locked
