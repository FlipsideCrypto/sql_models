...
LEFT OUTER JOIN {{ ref('flow_delegator_addresses')}} as d
  ON e.event_from = d.delegator_id
    AND e.event_to = d.node_id

LEFT OUTER JOIN {{ labels_join('d.delegator_address', 'flow', 'event_to_labels') }}
...
LEFT OUTER JOIN {{ labels_join('d.delegator_address', 'flow', 'event_from_labels') }}

LEFT OUTER JOIN {{ labels_join('e.event_to', 'flow', 'event_to_labels') }}
...
LEFT OUTER JOIN {{ labels_join('e.event_from', 'flow', 'event_from_labels') }}
